...
INSERT INTO usuarios ( email , nombre, primerapregunta , primerapreguntarespuesta , segundapregunta, segundapreguntarespuesta, admin, clave ) Values ( 'admin' , 'admin' , 'admin' , 'admin' , 'admin' , 'admin' , true , 'admin' );
